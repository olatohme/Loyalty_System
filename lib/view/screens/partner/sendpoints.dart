...
class SendPoint extends GetView<Send_Points> {
  SendPoint({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CustomTextField(
                    ...
                    onchange: (value) {
                      controller.num_points_partner = value;
                    },
                  ),
                ),
                //SizedBox(height: 20,),
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: phoneTextField(
          ...
          keyboardType: TextInputType.number,
          onchange: (value) {
            controller.number_partner = value.completeNumber;
          ...
          Center(
            child: Button(
              onPressed: () async {
                ...
                await controller.sendpoint_partner(
                ...
                controller
                    .isloading_balance(!controller.isloading_balance.value);
                if (controller.status_point_part == 200 ||
                    controller.status_point_part == 201) {
                  Get.back();
                }
                //Get.back();
              },
