...
class pagegems_send extends StatelessWidget {
  pagegems_send({Key? key}) : super(key: key);
              ...
              child: SingleChildScrollView(
                  ...
                  children: [
                    const SizedBox(
                     ...
                     controller5.transfer_gems!.gemsTransferSender!.length ==0?
                   ...
                   SizedBox(
                      ...
                      padding: const EdgeInsets.only(left: 20,right: 20),
                       ...
                       TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "تم ارسال  ${controller5.transfer_gems!.gemsTransferSender![index].value} جوهرة",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "${controller5.transfer_gems!.gemsTransferSender![index].receiverUser.fname} ${controller5.transfer_gems!.gemsTransferSender![index].receiverUser.lname} الى ",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    ...
                                    TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "${controller5.transfer_gems!.gemsTransferSender![index].createdAt}",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    SizedBox(
                          ...
                          itemCount: controller5.transfer_gems!.gemsTransferSender!.length),
                    ),
