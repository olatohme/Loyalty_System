...
class scanner_p extends StatefulWidget {
  scanner_p({Key? key}) : super(key: key);

  @override
  State<scanner_p> createState() => _scannerState();
}

class _scannerState extends State<scanner_p> {
  ...
  void onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      if (isCameraActive) {
        setState(() async{
          controller1.number_partner = scanData.code;
          isCameraActive = false;
         controller.stopCamera();
         EasyLoading.show(status: "loading..");
         
         await controller1.sendpoint_partner(
         ...
         controller1.isloading_balance(!controller1.isloading_balance.value);
          ...
          if (controller1.status_point_part == 200 ||
              controller1.status_point_part == 201) {
             Get.back();
          }
         print(scanData.code);
        });
