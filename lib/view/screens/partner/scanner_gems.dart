...
class scanner_gems_p extends StatefulWidget {
  scanner_gems_p({Key? key}) : super(key: key);

  @override
  State<scanner_gems_p> createState() => _scannerState();
}

class _scannerState extends State<scanner_gems_p> {
  ...
  void onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      if (isCameraActive) {
        setState(() async {
          controller1.number2_partner = scanData.code;
          ...
          if (controller1.status_gems_part == 200 ||
              controller1.status_gems_part == 201) {
            Get.back();
          }
          //print(scanData.code);
        });
