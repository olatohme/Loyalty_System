...
class pagegems_reseve extends StatelessWidget {
  pagegems_reseve({Key? key}) : super(key: key);
              ...
              Row(
                children: [
                  ...
                  const SizedBox(
                    ...
                    IconButton(
                    onPressed: () async {
                      controller5.isloading_record_g(! controller5.isloading_record_g.value);
                        controller5.transfer_gems = await controller5.GetTransfergems(controller1.TokenCustomer!);
                    controller5.isloading_record_g(! controller5.isloading_record_g.value);
                    },
              ...
              child: SingleChildScrollView(
                child:  Obx(() {
                  ...
                  children: [
                    ...
                    controller5.transfer_gems!.gemsTransferReceiver!.length==0?
                    controller5.status_transfer_g==200||controller5.status_transfer_g==201?
                    SizedBox(
                      height: 400,
                    ...
                    SizedBox(
                      ...
                      padding: const EdgeInsets.only(left: 20,right: 20),
                       ...
                       TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "تم استقبال  ${controller5.transfer_gems!.gemsTransferReceiver![index].value} جوهرة",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "${controller5.transfer_gems!.gemsTransferReceiver![index].senderUser.fname} ${controller5.transfer_gems!.gemsTransferReceiver![index].senderUser.lname} من ",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    ...
                                    TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "${controller5.transfer_gems!.gemsTransferReceiver![index].createdAt}",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    SizedBox(
                          ...
                          itemCount: controller5.transfer_gems!.gemsTransferReceiver!.length),
                    ),
          ...
          child: Column(
            ...
            children: [
              ...
              TextUtils(
                  ...
                  fontWeight: FontWeight.normal,
                  text:
                      "تم ارسال  ${controller5.transfer!.bonusTransferSender![index].value} نقطة",
                  // text: "name is: Adidas",
                  color: Colors.black,
                  underLine: TextDecoration.none),
              SizedBox(
              ...
              TextUtils(
                  ...
                  fontWeight: FontWeight.normal,
                  text:
                      "${controller5.transfer!.bonusTransferSender![index].receiverUser.fname} ${controller5.transfer!.bonusTransferSender![index].receiverUser.lname} الى ",
