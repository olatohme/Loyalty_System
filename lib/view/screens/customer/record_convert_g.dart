...
class page_convert_g extends StatelessWidget {
  page_convert_g({Key? key}) : super(key: key);
              ...
              child: Row(
                children: [
                  ...
                  TextUtils(
                    ...
                    text: "سجل تحويل الجواهر الى كاش   ",
                    color: Colors.white,
                ...
                child: Obx(() {
                  ...
                  return Column(
                    children: [
                      ...
                      controller5.convert_cash!.g2Cs.length == 0
                          ? controller5.status_convert_cash == 200 ||
                                  controller5.status_convert_cash == 201
                              ? SizedBox(
                                  height: 400,
                                  child: Center(
                                    child: TextUtils(
                          ...
                          : SizedBox(
                              ...
                              child: ListView.separated(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            TextUtils(
                                                ...
                                                fontWeight: FontWeight.normal,
                                                text:
                                                    "تم تحويل   ${controller5.convert_cash!.g2Cs[index].gems} جوهرة",
                                                // text: "name is: Adidas",
                                                color: Colors.black,
                                                underLine: TextDecoration.none),
                                            TextUtils(
                                                ...
                                                fontWeight: FontWeight.normal,
                                                text:
                                                    " الى \$ ${controller5.convert_cash!.g2Cs[index].cash} ",
                                                // text: "name is: Adidas",
                                                color: Colors.black,
                                                underLine: TextDecoration.none),
                                            TextUtils(
                                                ...
                                                fontWeight: FontWeight.normal,
                                                text:
                                                    "${controller5.convert_cash!.g2Cs[index].createdAt}",
                                                // text: "name is: Adidas",
                                                color: Colors.black,
                                                underLine: TextDecoration.none),
                                            SizedBox(
                                  ...
                                  itemCount: controller5.convert_cash!.g2Cs.length),
                            ),
                    ],
                  );
                }),
