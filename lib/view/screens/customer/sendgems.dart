...
class SendGems extends GetView<Send_Points> {
  SendGems({Key? key}) : super(key: key);
    ...
    Get.dialog(
      AlertDialog(
        ...
        content:phoneTextField(
                      ...
                      keyboardType: TextInputType.number,
                      onchange: (value) {
                        controller.number2 = value.completeNumber;
              ...
              onPressed: () async {
                ...
                EasyLoading.show(status: "Loadding..");
                      print("iiiiiiiiiiiiiiii${controller.number}");
                         await controller.sendgems_customer(
                      ...
                      controller.isloading_balance(
                       ...
                       if (controller.status_gems_cust == 200 ||
                          controller.status_gems_cust == 201) {
                        Get.back();
