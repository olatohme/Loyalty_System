...
class page_send extends StatelessWidget {
  page_send({Key? key}) : super(key: key);
                ...
                child: Obx(() {
                  ...
                  return Column(
                    children: [
                      ...
                      controller5.transfer!.bonusTransferSender!.length == 0
                          ...
                          : SizedBox(
                              ...
                              child: ListView.separated(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            TextUtils(
                                                ...
                                                fontWeight: FontWeight.normal,
                                                text:
                                                    "هذه النقاط صالحة حتى تاريخ ${controller5.transfer!.bonusTransferSender![index].expDate}",
                                                // text: "name is: Adidas",
                                                color: Colors.black,
                                                underLine: TextDecoration.none),
                                            TextUtils(
                                  ...
                                  itemCount: controller5
                                      .transfer!.bonusTransferSender!.length),
                            ),
                    ],
                  );
                }),
