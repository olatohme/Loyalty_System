...
class page_reseve extends StatelessWidget {
  page_reseve({Key? key}) : super(key: key);
              ...
              child: Row(
                children: [
                  ...
                  TextUtils(
                    ...
                    text: "سجل النقاط المؤقتة المستلمة ",
                    color: Colors.white,
                  ...
                  const SizedBox(
                   ...
                   IconButton(
                    onPressed: () async {
                      controller5.isloading_record(! controller5.isloading_record.value);
                        controller5.transfer = await controller5.GetTransferpoint(controller1.TokenCustomer!);
                    controller5.isloading_record(! controller5.isloading_record.value);
                    },
              ...
              child: SingleChildScrollView(
                child:  Obx(() {
                  ...
                  children: [
                    ...
                    controller5.transfer!.bonusTransferReceiver!.length==0?
                    controller5.status_transfer==200||controller5.status_transfer==201?
                    SizedBox(
                      height: 400,
                    ...
                    SizedBox(
                      ...
                      child: ListView.separated(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    TextUtils(
                                        ...
                                        fontWeight: FontWeight.normal,
                                        text:
                                            "هذه النقاط صالحة حتى تاريخ ${controller5.transfer!.bonusTransferReceiver![index].expDate}",
                                        // text: "name is: Adidas",
                                        color: Colors.black,
                                        underLine: TextDecoration.none),
                                    TextUtils(
                          ...
                          itemCount:controller5.transfer!.bonusTransferReceiver!.length ),
                    ),
                  ],
                );}),
              ),
