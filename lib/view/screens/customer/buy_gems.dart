...
class buy_gems extends StatelessWidget {
  // BundlesModel B=Get.arguments;

  var controller = Get.find<HomeController>();
  var controller1 = Get.find<AuthController>();
  var controller2 = Get.find<Send_Points>();
